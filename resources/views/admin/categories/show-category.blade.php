                                ...
                                <div class="row g-4">
                                        ...
                                        <div class="card border-0 shadow-sm h-100">
                                            <div class="card-body p-4">
                                                    ...
                                                    <div class="text-end">
                                                        <div class="mb-2">
                                                            <span class="badge bg-primary fs-6" id="showOrder">
                                                                <i class="bi bi-sort-numeric-up me-1"></i>{{ $category->display_order ?? 1 }}
                                                            </span>
                                                        </div>
                                                        <div>
                                                            <span class="badge bg-success fs-6" id="showStatus">
                                                                <i class="bi bi-check-circle me-1"></i>{{ $category->status ?? 'active' }}
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="p-3 bg-light rounded">
                                                    ...
                                                    <div class="fw-bold fs-5" id="showSection">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="card border-0 shadow-sm h-100">
                                            ...
                                            <div class="card-body p-4">
                                                <div class="d-grid gap-3">
                                                    <a class="btn btn-primary btn-lg" href="{{ route('category.edit', $category->id) }}">
                                        ...
                                        <div class="mt-3">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h3 class="card-title">Menu Items (Mock)</h3>
                                                </div>
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered align-middle mb-0">
                                                            ...
                                                            <tbody id="itemsTbody">
                                                                <tr>
                                                                    <td>1</td>
                                                                    <td><span class="fw-semibold">Margherita Pizza</span></td>
                                                                    <td class="text-muted">Cheese, tomato sauce, basil</td>
                                                                    <td>$12</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>2</td>
                                                                    <td><span class="fw-semibold">Chicken Burger</span></td>
                                                                    <td class="text-muted">Grilled chicken, fresh bun</td>
                                                                    <td>$9</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>3</td>
                                                                    <td><span class="fw-semibold">Caesar Salad</span></td>
                                                                    <td class="text-muted">Romaine, parmesan, dressing</td>
                                                                    <td>$8</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <div class="small text-muted mt-2">
                                                        Replace this table with real backend data later.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        {{-- <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-grid gap-2">
                                                        <button type="button" id="copyDetails" class="btn btn-primary">
                                                            <i class="bi bi-clipboard me-1"></i> Copy details
                                                        </button>
                                                        <button type="button" id="toggleStatus"
                                                            class="btn btn-outline-secondary">
                                                            <i class="bi bi-toggle2-off me-1"></i> Toggle status (UI)
                                                        </button>
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('section.edit', $section->id ?? 1) ?? url('admin/sections/edit') }}"
                                                            onclick="return true;">
                                                            <i class="bi bi-pencil me-1"></i> Edit (route placeholder)
                                                        </a>
                                                    </div>

                                                    <div class="mt-3 alert alert-warning" role="alert">
                                                        Note: there is <b>no backend</b>. Buttons only modify the UI.
                                                    </div> --}}
                            </div>
                        </div>
                    </div>
