                                ...
                                <form method="POST" action="{{ route('table.store') }}" class="needs-validation" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="table_number" type="text" name="table_number" value="{{ old('table_number') }}" autofocus
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="type_private" name="type" value="private"
                                                {{ old('type') === 'private' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check mt-2">
                                            <input class="form-check-input" type="radio" id="type_public" name="type" value="public"
                                                {{ old('type') === 'public' ? 'checked' : '' }} required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="min_capacity" type="number" name="min_capacity" value="{{ old('min_capacity') }}"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="max_capacity" type="number" name="max_capacity" value="{{ old('max_capacity') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="location" name="location" class="form-select @error('location') is-invalid @enderror">
                                                ...
                                                <option value="Ground Floor" {{ old('location') === 'Ground Floor' ? 'selected' : '' }}>Ground Floor</option>
                                                <option value="First Floor" {{ old('location') === 'First Floor' ? 'selected' : '' }}>First Floor</option>
                                    ...
                                    <div class="d-flex gap-2 mt-4">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bi bi-check-lg me-1"></i> Save Table
                                        </button>
                                    </div>
                                </form>
                            </div>
