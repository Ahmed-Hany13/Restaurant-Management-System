                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="name" type="text" name="name"
                                                        value="{{ old('name', $subcategory->name) }}" autofocus
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select id="menu_category_id" name="menu_category_id"
                                                    ...
                                                    <option value="" disabled
                                                        {{ old('menu_category_id', $subcategory->menu_category_id) ? '' : 'selected' }}>
                                                        Select category
                                                    </option>
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}"
                                                            {{ (string) old('menu_category_id', $subcategory->menu_category_id) === (string) $category->id ? 'selected' : '' }}>
                                                            {{ $category->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-5">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="display_order" type="number" name="display_order"
                                                            value="{{ old('display_order', $subcategory->display_order ?? 1) }}"
                                            ...
                                            <div class="d-flex align-items-center justify-content-between gap-2 mt-3">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="bi bi-pencil me-1"></i> Update Subcategory
                                                </button>
                                            </div>
                                        </div>
                                    </div>
